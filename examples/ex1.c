...
/*TEST
  ...
  test:
    ...
    args: -f_training $PERMON_SVM_DIR/examples/data/heart_scale.bin -f_kernel $PERMON_SVM_DIR/examples/data/heart_scale.kernel.bin
    args: -f_test $PERMON_SVM_DIR/examples/data/heart_scale.t.bin
