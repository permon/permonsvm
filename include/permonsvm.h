...
FLLOP_EXTERN PetscErrorCode PermonSVMSetCMin(PermonSVM svm, PetscReal C_min);
FLLOP_EXTERN PetscErrorCode PermonSVMGetCMin(PermonSVM svm, PetscReal *C_min);
FLLOP_EXTERN PetscErrorCode PermonSVMSetCMax(PermonSVM svm, PetscReal C_max);
FLLOP_EXTERN PetscErrorCode PermonSVMGetCMax(PermonSVM svm, PetscReal *C_max);
FLLOP_EXTERN PetscErrorCode PermonSVMSetCStep(PermonSVM svm, PetscReal C_step);
FLLOP_EXTERN PetscErrorCode PermonSVMGetCStep(PermonSVM svm, PetscReal *C_step);
