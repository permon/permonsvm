...
FLLOP_EXTERN PetscErrorCode SVMSetTrainingSamples(SVM svm,Mat Xt_training,Vec y_training);
FLLOP_EXTERN PetscErrorCode SVMGetTrainingSamples(SVM svm,Mat *Xt_training,Vec *y_training);
